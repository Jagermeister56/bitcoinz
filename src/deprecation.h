...
static const int APPROX_RELEASE_HEIGHT = 1273100; // Dec 2023
static const int WEEKS_UNTIL_DEPRECATION = 52;
static const int DEPRECATION_HEIGHT = APPROX_RELEASE_HEIGHT + (WEEKS_UNTIL_DEPRECATION * 7 * 52 * 52);

// Number of blocks before deprecation to warn users
static const int DEPRECATION_WARN_LIMIT = 14 * 48 * 48; // 4 weeks
/**
